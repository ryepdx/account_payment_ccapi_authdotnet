...
class auth_net_cc_api(osv.osv):
    ...
    def cancel_sales_receipt(self, cr, uid, ids, context={}):
        voucher_obj = self.pool.get('account.voucher')
...
#                        inv_vals['sale_account_id'] = ship_method.account_id and ship_method.account_id.id,
                    ...
                    for line in refund_lines:
                        ...
                        onchange_vals = invoice_line_obj.product_id_change(cr, uid, [], line['product_id'], False, line['qty'], '', 'out_refund', inv_vals['partner_id'], context={})['value']
